...
namespace Tarodev_Pathfinding._Scripts
{
    ...
    ///     don't use this in an RTS without first applying some optimization mentioned in the video:
    ...
    {
        private static readonly Color PathColor = new(0.65f, 0.35f, 0.35f);
        private static readonly Color OpenColor = new(.4f, .6f, .4f);
        private static readonly Color ClosedColor = new(0.35f, 0.4f, 0.5f);
